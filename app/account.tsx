...
export default function AccountScreen() {
  ...
  // Logged-in users never land here — the avatar button in index.tsx
  // goes directly to /(dashboard). Render nothing as a safety net.
  if (user) return null;
  ...
  return (
    <View style={[styles.screen, { backgroundColor: colors.bg }]}>
      ...
      <View style={styles.empty}>
        ...
        <Pressable
          onPress={() => dispatch(openAuthSheet('login'))}
          style={[
            {
        ...
        >
          <Text
            style={[
              typo.scale.body,
              { fontFamily: typo.fonts.sansBold, color: colors.textOnAccent },
            ]}
          >
            Sign In
          </Text>
        ...
        <Pressable
          onPress={() => dispatch(openAuthSheet('register'))}
          style={[
            {
              borderWidth: 1,
